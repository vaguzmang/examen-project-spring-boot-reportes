...
CREATE TABLE movimiento (
    ...
    CONSTRAINT chk_movimiento_bodegas CHECK (
        ...
        OR
        (tipo='SALIDA' AND bodega_origen_id IS NOT NULL AND bodega_destino_id IS NULL)
        OR
...
CREATE INDEX idx_auditoria_producto ON auditoria(producto_id);
CREATE INDEX idx_auditoria_campo ON auditoria(campo_modificado);