...
function aplicarPermisosNavegacion() {
    ...
    const puedeVerAbastecimiento =
        usuario.rol === "ADMIN" ||
        usuario.rol === "SUPERADMIN" ||
        usuario.rol === "AGENTE";

    const proveedorNavItem =
        document.getElementById("proveedorNavItem");

    const ordenNavItem =
        document.getElementById("ordenNavItem");

    const supplySectionLabel =
        document.getElementById("supplySectionLabel");

    if (proveedorNavItem) {
        proveedorNavItem.classList.toggle(
            "hidden",
    ...
    if (ordenNavItem) {
        ordenNavItem.classList.toggle(
            "hidden",
            !puedeVerAbastecimiento
        );
    }

    if (supplySectionLabel) {
        supplySectionLabel.classList.toggle(
            "hidden",
            !puedeVerAbastecimiento
        );
    }
